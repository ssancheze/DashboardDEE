...
class CameraController:
    ...
    def buildFrame(self, frame):
        ...
        self.takePictureButton = tk.Button(self.cameraControlFrame, text="Take Picture", bg='red', fg="white", command=self.takePictureButtonClicked)
        self.takePictureButton.grid(column=0, row=0, pady = 5, padx = 5, sticky=tk.N + tk.S + tk.E + tk.W)
        self.clearPictureButton = tk.Button(self.cameraControlFrame, text="Clear picture",bg = 'red', fg="white", command=self.clearPictureButtonClicked)
        self.clearPictureButton.grid(column=1, row=0, pady = 5, padx = 5, sticky=tk.N + tk.S + tk.E + tk.W)
        ...
        self.videoStreamButton = tk.Button(self.cameraControlFrame, text="Start video stream", bg='red', fg="white",
                                      command=self.videoStreamButtonClicked)
        self.videoStreamButton.grid(column=0, row=2, columnspan=2,  pady = 5, padx = 5, sticky=tk.N + tk.S + tk.E + tk.W)
