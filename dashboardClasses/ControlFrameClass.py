...
class ControlFrame:
    ...
    def goN(self):
        for droneId in range(6):
            if self.activeDronesList[droneId] == 1:
                if self.onAir[droneId]:
    ...
    def arm(self):
        for droneId in range(6):
            if self.activeDronesList[droneId] == 1:
                ...
                elif not self.state[droneId] == "flying":
